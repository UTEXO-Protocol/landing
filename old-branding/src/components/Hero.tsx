...
export default function Hero() {
  return (
    <section className="relative overflow-visible px-4 sm:px-0">
      <div className="pb-4 sm:pb-16 lg:pb-20 mx-auto w-full sm:w-[640px] md:w-11/12 border-[#C6C6C6] border-l-0 sm:border-l border-r-0 sm:border-r">
        <div className="relative bg-[rgb(26,46,26)] overflow-visible h-[550px] sm:h-[550px] lg:h-[740px] mx-auto">
          {/* Background Image */}
    ...
    filter: "drop-shadow(0 20px 30px rgba(0,0,0,0.4))"
          ...
          <div className="relative z-10 px-6 sm:px-12 lg:px-[120px] py-8 sm:py-12 lg:py-[80px]">
            <div className="w-full max-w-[760px]">
              <h1 
                className="text-5xl sm:text-[56px] lg:text-[80px] font-medium leading-[48px] sm:leading-[60px] lg:leading-[82px] tracking-[-0.03em] text-white mb-4 sm:mb-7 lg:mb-8 h-auto lg:h-[164px] font-sans text-shadow-xs"
              >
                Bitcoin&apos;s private<br />
                stablecoin backbone
              </h1>

          <div className="block sm:hidden pb-6 bottom-8 sm:bottom-12 lg:bottom-[80px] right-4 sm:right-6 lg:right-[30px] max-w-[280px] sm:max-w-[340px] lg:max-w-[400px] z-10">
            <p className="text-white text-sm leading-normal text-shadow-xs ">
          ...
          {/* Text Overlay */}
          <div className="hidden sm:block sm:absolute bottom-8 sm:bottom-12 lg:bottom-[80px] right-4 sm:right-6 lg:right-[30px] max-w-[280px] sm:max-w-[340px] lg:max-w-[400px] z-10">
