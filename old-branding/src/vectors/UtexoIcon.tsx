export default function UtexoIcon({className = "", hideShadow, shadowSize = "10px"}: {className?: string, hideShadow?: boolean, shadowSize?: string}) {
  return (
    <svg  className={`${hideShadow ? '' : `drop-shadow-[0_6px_${shadowSize}_rgba(0,0,0,0.25)]`} ${className}`} width="128" height="128" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
