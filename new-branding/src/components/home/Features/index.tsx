      ...
      <div className="features__grid">
        {featuresList.map(feature => (
          <article key={feature.title} className="features__card">
            <div className="features__card__tag">{feature.tag}</div>

            <div className="features__card__body">
              <div className="features__card__header">
                <div className="features__card__icon">{feature.icon}</div>
                <h3 className="features__card__title">{feature.title}</h3>
              </div>
              <p className="features__card__description">{feature.description}</p>
            </div>
          </article>
        ))}
      </div>
