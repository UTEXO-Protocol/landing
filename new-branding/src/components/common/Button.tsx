...
//                 <Image src="/common/Vector.png" alt="arrow-right" width={iconSize.width} height={iconSize.height} />
//               </>
//             )}
//             {/* Ice/Glare Effect */}
...
export default function Button({
  ...
  const contents = (
    <>
      {iconOnly ? (
        <Image
          src={variant == "white" ? "/common/Arrow-right-black.png" : "/common/Vector.png"}
          alt="arrow"
          width={iconSize.width}
          height={iconSize.height}
          className={iconRotation}
