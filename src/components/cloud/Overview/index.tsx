    ...
    <section className="cloud-overview">
      <div className="cloud-overview__inner">
        <p className="cloud-overview__text">
          Utexo cloud offers managed execution infrastructure for applications
          that require direct control over node-level components.
        </p>
          ...
          {cloudOverviewFeatures.map((feature) => (
            <li key={feature.text} className="cloud-overview__feature">
              <Image
                ...
                width={24}
                height={24}
                className="cloud-overview__feature-icon"
              />
              <span className="cloud-overview__feature-text">
                {feature.text}
              </span>
            </li>
          ))}
