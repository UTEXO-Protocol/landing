...
export default function BridgeProductDeepdive() {
  return (
    <section
      id="ProductSuite"
      className="w-full mx-auto text-white relative overflow-hidden lg:overflow-visible px-4 sm:px-0 lg:px-0 py-0 sm:py-0 lg:py-0"
    >
      <div className="w-full sm:w-[640px] md:w-11/12 bg-black mx-auto">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-5 lg:gap-6">
          ...
          {/* LEFT (copy + 3D) */}
          <div className="order-1 col-span-1 flex flex-col justify-between relative pt-7.5 px-4 pb-11.5 md:px-15 md:pt-15">
          ...
          <div className="order-last col-span-1 lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-0">
            ...
            <div className="flex flex-col border border-white/10 p-5 md:p-6 lg:p-7.5">
              <div className="w-[78px] h-[78px] mb-16 sm:mb-24 lg:mb-[168px] bg-[#1A1A1A] border-white/10 flex items-center justify-center">
