            ...
            {[
              {
                ...
                copy: "Reliable uptime with globally distributed infrastructure.",
              },
              {
                icon: "/Check-Shield-Icon.svg",
                title: "Non-Custodial Security",
                copy: "Sign locally via PSBT; your keys never leave your device.",
              },
              {
                icon: "/Expand-Diagonali-Icon.svg",
                title: "Scalable & Automated",
                copy: "Grow on demand with no manual setup or downtime.",
              },
              {
                icon: "/Cog-Icon.svg",
          ...
          <div className="col-span-1 flex flex-col justify-between relative p-6 sm:p-8 lg:p-9">
            <div className="space-y-6 sm:space-y-7 lg:space-y-8">
              <h2 className="text-[40px] sm:text-[48px] lg:text-[80px] leading-tight sm:leading-[50px] lg:leading-[90%] tracking-[-0.03em] font-sans">
                Utexo Cloud — RGB<br />Infrastructure<br />as a Service.
              </h2>
               <p className="font-sans text-[14px] sm:text-[15px] lg:text-[16px] text-white leading-snug" style={{ fontFamily: "'PP Mori', sans-serif" }}>
                Manage RGB and Lightning nodes effortlessly with our cloud platform. Always available, secure,
                and integration-ready for developers, businesses, and enterprises.
              </p>
