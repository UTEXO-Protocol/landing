        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-y-10 lg:gap-x-10 py-12 lg:py-24">
          ...
          <div className="lg:col-span-3 relative pr-20">
            ...
            {[
              ...
              { label: "Maintenance", self: "Full DevOps", dev: "No infrastructure required" },
              { label: "Security", self: "Manual configuration", dev: "Non-custodial by design" },
              { label: "Scalability", self: "Limited", dev: "Scales with Utexo’s backend" },
              { label: "Uptime", self: "Unreliable", dev: "Always-on API access" },
            ].map((row, i) => (
